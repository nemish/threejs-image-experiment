...
const lights = [];
lights[0] = new PointLight(0xffffff, 5, 0);
lights[1] = new PointLight(0xffffff, 5, 0);
lights[2] = new PointLight(0xffffff, 5, 0);
...
const texture = new TextureLoader().load( "/dicaprio.jpg", onLoad);
